...
//283行目に && menuPanel.activeSelf を追加
//メニューパネルがアクティブであれば、UIがマウスのクリックに反応する
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class TitleStandaloneInputModule : PointerInputModule
    {
        ...
        protected TitleStandaloneInputModule()
        {
        }
        ...
        public override void Process()
        {
            ...
            if (!ProcessTouchEvents() && input.mousePresent && menuPanel.activeSelf)
                ProcessMouseEvent();
